    ...
    public partial class testmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogEntrys", x => x.BlogEntryId);
                    table.ForeignKey(
                        name: "FK_BlogEntrys_Blogs_BlogId",
                        column: x => x.BlogId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "This is a test description", "Jimmy-white.jpeg", "High Heels Jimmy Choo" },
            ...
            migrationBuilder.InsertData(
                table: "BlogEntrys",
                columns: new[] { "BlogEntryId", "BlogId", "Content", "EntryTitle", "PostTime" },
                values: new object[,]
                {
                    { 1, 1, "The shoe is the last one of Virgil's Off-White collab for the Air Max 90's and is probably the best design he has to date. They are not true to size and seem to run a half size smaller. The upper's are wonderfully designed, the lower portion in my eye's is where they really shine at. As with all of his Off-White creations as of late, the added print is very reminiscent of Andy Warhol, and I dig it. As far as paying retail for these shoes, they are awesome, but I wouldn't recommend paying resale pricing unless you are okay with wearing shoes that near the thousand dollar mark.", null, new DateTime(2019, 6, 30, 19, 18, 35, 71, DateTimeKind.Local) },
                    { 2, 2, "The shoe is as beautiful as it looks on the site. It's does run small so, I would recommend a 1/2 size up. As long as you're used to wearing heels they are good for an all night wear. Perfect for a dramatic night on the town or an elegant night out. Would I recommend this shoe? Absolutely!", null, new DateTime(2019, 6, 30, 19, 18, 35, 73, DateTimeKind.Local) },
                    { 3, 3, "Coffee? yes. Iced or Cold brew coffee? Even better. This stuff right here? The best there is, hands down, nothing else wakes me up faster than this.", null, new DateTime(2019, 6, 30, 19, 18, 35, 73, DateTimeKind.Local) },
                    { 4, 4, "Feel it within 15 minutes of drinkning it, fantastic for body building and tastes GREAT!!!!", null, new DateTime(2019, 6, 30, 19, 18, 35, 73, DateTimeKind.Local) }
                });

            migrationBuilder.CreateIndex(
                name: "IX_BlogEntrys_BlogId",
                table: "BlogEntrys",
                column: "BlogId");
